...
struct kavi_t *kavi_open(const char *filename, int width, int height, const char *fourcc, int fps, struct kohn_avi_audio_t *audio);
void kavi_add_frame(struct kavi_t *kavi, const unsigned char *buffer, int len);
void kavi_add_audio(struct kavi_t *kavi, const unsigned char *buffer, int len);
